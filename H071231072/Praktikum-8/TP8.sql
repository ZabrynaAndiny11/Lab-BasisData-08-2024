#nomor 1
(SELECT productName,SUM(od.quantityOrdered*od.priceEach)AS 'TotalRevenue',
...
c.customerNumber, 
'Membayar Pesanan dan Memesan Barang' 
AS riwayat
FROM customers c
JOIN orders o
USING(customerNumber)
...
SELECT p2.paymentDate FROM payments p2
)
